...
const createEnrolledCourseIntoDB = async (
  ...
  const student = await MStudent.findOne({ id: userId }, { _id: 1 });
...
const getMyEnrolledCoursesFromDB = async (
  ...
  const student = await MStudent.findOne({ id: studentId });
...
const updateEnrolledCourseMarksIntoDB = async (
  ...
  const isStudentExists = await MStudent.findById(student);
